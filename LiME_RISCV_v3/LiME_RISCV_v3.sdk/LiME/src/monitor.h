...
inline void stats_start(void)
{
	...
	XAxiPmon_SetMetrics(&apm, 0, XAPM_METRIC_SET_5,  XAPM_METRIC_COUNTER_4); // Total Read Latency
	XAxiPmon_SetMetrics(&apm, 0, XAPM_METRIC_SET_6,  XAPM_METRIC_COUNTER_5); // Total Write Latency
	XAxiPmon_SetMetrics(&apm, 0, XAPM_METRIC_SET_9,  XAPM_METRIC_COUNTER_6); // Bvalids
	...
	//XAxiPmon_EnableGlobalClkCounter(&apm);
...
inline void stats_stop(void)
{
	...
	//XAxiPmon_DisableGlobalClkCounter(&apm);
}
...
inline void stats_print(void)
{
	...
	u32 count1, count2, count3, count4, count5, count6, count7;
	count1 = XAxiPmon_GetMetricCounter(&apm, XAPM_METRIC_COUNTER_0);
	count2 = XAxiPmon_GetMetricCounter(&apm, XAPM_METRIC_COUNTER_1);
	count3 = XAxiPmon_GetMetricCounter(&apm, XAPM_METRIC_COUNTER_2);
	count4 = XAxiPmon_GetMetricCounter(&apm, XAPM_METRIC_COUNTER_3);
	count5 = XAxiPmon_GetMetricCounter(&apm, XAPM_METRIC_COUNTER_4);
	count6 = XAxiPmon_GetMetricCounter(&apm, XAPM_METRIC_COUNTER_5);
	count7 = XAxiPmon_GetMetricCounter(&apm, XAPM_METRIC_COUNTER_6);
...
{
	*((int *)XPAR_TDC_V2_0_S00_AXI_BASEADDR) = 1;
}

inline void trace_stop(void)
{
	last_addr = *((int *)XPAR_TDC_V2_0_S00_AXI_BASEADDR + 1);
	*((int *)XPAR_TDC_V2_0_S00_AXI_BASEADDR) = 0;
	return;
}
