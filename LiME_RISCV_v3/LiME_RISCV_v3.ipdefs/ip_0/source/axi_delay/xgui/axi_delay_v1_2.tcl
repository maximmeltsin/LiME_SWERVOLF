...
proc init_gui { IPINST } {
	...
	set PROTOCOL [ipgui::add_param $IPINST -parent $Page0 -name PROTOCOL]
	set C_AXI_PROTOCOL [ipgui::add_param $IPINST -parent $Page0 -name C_AXI_PROTOCOL]
	set C_MEM_ADDR_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_MEM_ADDR_WIDTH]
	set C_COUNTER_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_COUNTER_WIDTH]
	set C_FIFO_DEPTH_AW [ipgui::add_param $IPINST -parent $Page0 -name C_FIFO_DEPTH_AW]
	set C_FIFO_DEPTH_W [ipgui::add_param $IPINST -parent $Page0 -name C_FIFO_DEPTH_W]
	set C_FIFO_DEPTH_B [ipgui::add_param $IPINST -parent $Page0 -name C_FIFO_DEPTH_B]
	set C_FIFO_DEPTH_AR [ipgui::add_param $IPINST -parent $Page0 -name C_FIFO_DEPTH_AR]
	set C_FIFO_DEPTH_R [ipgui::add_param $IPINST -parent $Page0 -name C_FIFO_DEPTH_R]
	set C_AXI_LITE_ADDR_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_AXI_LITE_ADDR_WIDTH]
	set C_AXI_LITE_DATA_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_AXI_LITE_DATA_WIDTH]
