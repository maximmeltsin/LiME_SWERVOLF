...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_FIFO_DEPTH_AR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_FIFO_DEPTH_AW" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_FIFO_DEPTH_B" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_FIFO_DEPTH_R" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_FIFO_DEPTH_W" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_MEM_ADDR_WIDTH" -parent ${Page_0}
